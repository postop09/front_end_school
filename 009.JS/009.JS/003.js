...
document.write('변수하나*변수둘 : ', 변수하나*변수둘);
document.write('<br>');
document.write('변수하나**변수셋 : ', 변수하나**변수셋); // **(제곱): 20의 2제곱
document.write('<br>');
document.write('변수하나%변수셋 : ', 변수하나%변수셋);
document.write('<br>');
document.write('변수하나-변수둘 : ', 변수셋-변수하나);
...
document.write('<br>');
//ES6
// 현업에서는 let을 사용하지만, 교육 동안은 var를 이용하자.
const 이름 = '이호준';
...
// parse: '변환'의 개념
// int: 정수 ------10진수------ㄱ
document.write(parseInt(num/3), 10, '<br>');  // 3
...
// 최대: 9007199254740991 (2^53-1 / 2**53-1)
